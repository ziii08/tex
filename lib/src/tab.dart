...
const table = {
  ...
  "\\ge": {"code": "TEX-N-2265", "w": 950, "h": 750, "d": 100},
  ...
  "\\le": {"code": "TEX-N-2264", "w": 950, "h": 750, "d": 100},
  ...
  "\\operatorname": {"code": "TEX-N-6F", "w": 500, "h": 750, "d": 0},
  "\\tfrac": {"code": "TEX-N-2044", "w": 500, "h": 750, "d": 250},
  "\\frac": {"code": "TEX-N-2044", "w": 500, "h": 750, "d": 250},
  "\\dfrac": {"code": "TEX-N-2044", "w": 600, "h": 850, "d": 300},
  "\\quad": {"code": "TEX-N-2003", "w": 1000, "h": 0, "d": 0},
  "\\mathbf": {"code": "TEX-N-1D41A", "w": 500, "h": 750, "d": 0},
  ...
  "\\mathbf{A}": {"code": "TEX-B-41", "w": 750, "h": 750, "d": 0},
  "\\mathbf{B}": {"code": "TEX-B-42", "w": 700, "h": 750, "d": 0},
  "\\mathbf{C}": {"code": "TEX-B-43", "w": 750, "h": 750, "d": 0},
  "\\mathbf{D}": {"code": "TEX-B-44", "w": 750, "h": 750, "d": 0},
  "\\mathbf{E}": {"code": "TEX-B-45", "w": 750, "h": 750, "d": 0},
  "\\mathbf{F}": {"code": "TEX-B-46", "w": 700, "h": 750, "d": 0},
  "\\mathbf{G}": {"code": "TEX-B-47", "w": 750, "h": 750, "d": 0},
  "\\mathbf{H}": {"code": "TEX-B-48", "w": 750, "h": 750, "d": 0},
  "\\mathbf{I}": {"code": "TEX-B-49", "w": 350, "h": 750, "d": 0},
  "\\mathbf{J}": {"code": "TEX-B-4A", "w": 450, "h": 750, "d": 0},
  "\\mathbf{K}": {"code": "TEX-B-4B", "w": 750, "h": 750, "d": 0},
  "\\mathbf{L}": {"code": "TEX-B-4C", "w": 650, "h": 750, "d": 0},
  "\\mathbf{M}": {"code": "TEX-B-4D", "w": 850, "h": 750, "d": 0},
  "\\mathbf{N}": {"code": "TEX-B-4E", "w": 750, "h": 750, "d": 0},
  "\\mathbf{O}": {"code": "TEX-B-4F", "w": 750, "h": 750, "d": 0},
  "\\mathbf{P}": {"code": "TEX-B-50", "w": 700, "h": 750, "d": 0},
  "\\mathbf{Q}": {"code": "TEX-B-51", "w": 750, "h": 750, "d": 0},
  "\\mathbf{R}": {"code": "TEX-B-52", "w": 750, "h": 750, "d": 0},
  "\\mathbf{S}": {"code": "TEX-B-53", "w": 500, "h": 750, "d": 0},
  "\\mathbf{T}": {"code": "TEX-B-54", "w": 750, "h": 750, "d": 0},
  "\\mathbf{U}": {"code": "TEX-B-55", "w": 750, "h": 750, "d": 0},
  "\\mathbf{V}": {"code": "TEX-B-56", "w": 750, "h": 750, "d": 0},
  "\\mathbf{W}": {"code": "TEX-B-57", "w": 1000, "h": 750, "d": 0},
  "\\mathbf{X}": {"code": "TEX-B-58", "w": 750, "h": 750, "d": 0},
  "\\mathbf{Y}": {"code": "TEX-B-59", "w": 750, "h": 750, "d": 0},
  "\\mathbf{Z}": {"code": "TEX-B-5A", "w": 650, "h": 750, "d": 0},
  "\\mathbf{a}": {"code": "TEX-B-61", "w": 550, "h": 500, "d": 0},
  "\\mathbf{b}": {"code": "TEX-B-62", "w": 550, "h": 750, "d": 0},
  "\\mathbf{c}": {"code": "TEX-B-63", "w": 500, "h": 500, "d": 0},
  "\\mathbf{d}": {"code": "TEX-B-64", "w": 550, "h": 750, "d": 0},
  "\\mathbf{e}": {"code": "TEX-B-65", "w": 500, "h": 500, "d": 0},
  "\\mathbf{f}": {"code": "TEX-B-66", "w": 350, "h": 750, "d": 0},
  "\\mathbf{g}": {"code": "TEX-B-67", "w": 550, "h": 500, "d": 200},
  "\\mathbf{h}": {"code": "TEX-B-68", "w": 550, "h": 750, "d": 0},
  "\\mathbf{i}": {"code": "TEX-B-69", "w": 300, "h": 750, "d": 0},
  "\\mathbf{j}": {"code": "TEX-B-6A", "w": 300, "h": 750, "d": 200},
  "\\mathbf{k}": {"code": "TEX-B-6B", "w": 550, "h": 750, "d": 0},
  "\\mathbf{l}": {"code": "TEX-B-6C", "w": 300, "h": 750, "d": 0},
  "\\mathbf{m}": {"code": "TEX-B-6D", "w": 850, "h": 500, "d": 0},
  "\\mathbf{n}": {"code": "TEX-B-6E", "w": 550, "h": 500, "d": 0},
  "\\mathbf{o}": {"code": "TEX-B-6F", "w": 550, "h": 500, "d": 0},
  "\\mathbf{p}": {"code": "TEX-B-70", "w": 550, "h": 500, "d": 200},
  "\\mathbf{q}": {"code": "TEX-B-71", "w": 550, "h": 500, "d": 200},
  "\\mathbf{r}": {"code": "TEX-B-72", "w": 400, "h": 500, "d": 0},
  "\\mathbf{s}": {"code": "TEX-B-73", "w": 400, "h": 500, "d": 0},
  "\\mathbf{t}": {"code": "TEX-B-74", "w": 350, "h": 650, "d": 0},
  "\\mathbf{u}": {"code": "TEX-B-75", "w": 550, "h": 500, "d": 0},
  "\\mathbf{v}": {"code": "TEX-B-76", "w": 500, "h": 500, "d": 0},
  "\\mathbf{w}": {"code": "TEX-B-77", "w": 750, "h": 500, "d": 0},
  "\\mathbf{x}": {"code": "TEX-B-78", "w": 500, "h": 500, "d": 0},
  "\\mathbf{y}": {"code": "TEX-B-79", "w": 500, "h": 500, "d": 200},
  "\\mathbf{z}": {"code": "TEX-B-7A", "w": 450, "h": 500, "d": 0},
